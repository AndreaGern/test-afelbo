                                ...
                                <div class="col-12 col-xl-12">
                                    <div class="card">
                                        <div class="card-header">
                                            <h5 class="font-weight-bold text-uppercase">Storico delle ripartizioni a te
                                                assegnate</h5>
                                        </div>
                                        <div class="card-body">
                                            <div class="container">
                                                    ...
                                                    <div class="col-12">
                                                        @if ($tasks)
                                                            <form action="{{ route('operator.changeDateTasksIndex') }}"
                                                                method="get">
                                                                @csrf
                                                                <h6 class="mb-3 font-weight-bold">Filtra per data di
                                                                    creazione
                                                                </h6>
                                                                            ...
                                                                            <div class="card-body">
                                                                                <div class="card-text">
                                                                                    <div class="container">
                                                                                        ...
                                                                                        @if ($task->process)
                                                                                            @include(
                                                                                                'operator.components.completed-row',
                                                                                                [
                                                                                                    'task' => $task,
                                                                                                    'loop' => $loop,
                                                                                                ]
                                                                                            ...
                                                                                            @include(
                                                                                                'operator.components.cancel-row',
                                                                                                [
                                                                                                    'task' => $task,
                                                                                                    'loop' => $loop,
                                                                                                ]
